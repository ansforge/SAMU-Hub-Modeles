...
/**
 * Class representing the Recipient model.
 *
 * @package Hubsante\Model\rcde
 * @author  OpenAPI Generator team
 */
...
class Recipient 
{
    ...
    * Sets name.
    *
    * @param string|null $name  Identifiant technique du système emetteur Format :  => Pour les SAMU : {clé de routage}-{nom solution LRM} où clé de routage désigne le nom de la clé de routage utilisée par le LRM pour les échanges et {nom solution LRM} est le nom donné par l'éditeur à sa solution (libre) => Pour NeXSIS : à définir {sga|sgo}-nexsis
    *
    * @return $this
    */
    ...
    * Sets uRI.
    *
    * @param string|null $uRI  uri du système. Permet d'identifier le vecteur utilisé par les échanges Format : => Pour les LRM : sge:{recipient:name} => Pour NexSIS : sge:{recipient:name}
    *
    * @return $this
    */
