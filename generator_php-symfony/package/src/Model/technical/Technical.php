...
/**
 * Class representing the Technical model.
 *
 * @package Hubsante\Model\technical
 * @author  OpenAPI Generator team
 */
...
class Technical 
{
     ...
     *
     * @var string|null
     * @SerializedName("requiredStringField")
     * @Type("string")
    */
    #[Assert\NotNull]
    #[Assert\Type("string")]
    protected ?string $requiredStringField = null;
    ...
    */
     ...
     * @Type("Hubsante\Model\technical\TechnicalObject")
    */
    #[Assert\Type("Hubsante\Model\technical\TechnicalObject")]
