...
module Resourcesrequest
  class Request
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'convention')
        self.convention = attributes[:'convention']
      end
    ...
    # @param [Object] convention Object to be assigned
    def convention=(convention)
      validator = EnumAttributeValidator.new('String', ["DRSIS", "MISSION", "ITSP", "CARENCE", "CONVENT", "SPE", "HORS", "AUTRE1", "AUTRE2", "AUTRE3"])
      unless validator.valid?(convention)
        fail ArgumentError, "invalid value for \"convention\", must be one of #{validator.allowable_values}."
      end
      @convention = convention
    end
    ...
    def purpose=(purpose)
      validator = EnumAttributeValidator.new('String', ["SAP", "REGUL", "CUMP", "SMUR", "MG", "PARAMED", "SAMU", "RELEVE", "NOVI", "TIH", "BRANCARD", "BARIA"])
    ...
    def hash
      [request_id, datetime, convention, purpose, deadline, freetext].hash
    end
