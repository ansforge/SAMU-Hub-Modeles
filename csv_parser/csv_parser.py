...
df.to_csv(f'out/{args.sheet}/{args.sheet}.input.csv')
...
with open(f'out/{args.sheet}/{args.sheet}.example.json', 'w') as outfile:
...
doc.save(f'out/{args.sheet}/{args.sheet}.schema.docx')
