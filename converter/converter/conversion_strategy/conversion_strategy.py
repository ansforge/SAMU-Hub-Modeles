...
def conversion_strategy(edxl_json, source_version: str, target_version: str, is_cisu_conversion: bool):
    if is_cisu_conversion:
        return cisu_conversion_strategy(edxl_json, source_version)
    else:
