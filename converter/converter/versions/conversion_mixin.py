...
class ConversionMixin:
    ...
    def copy_input_content(cls, input_json: Dict[str, Any]) -> Dict[str, Any]:
        ...
        del output_json[cls.CONTENT_KEY][0][cls.JSON_CONTENT_KEY][cls.EMBEDDED_JSON_CONTENT_KEY][cls.MESSAGE_KEY][message_type]
        return output_json
    ...
    def copy_input_use_case_content(cls, input_json: Dict[str, Any]) -> Dict[str, Any]:
        message_type = cls.get_message_type()
        input_use_case_json = (
            input_json[cls.CONTENT_KEY][0][cls.JSON_CONTENT_KEY][cls.EMBEDDED_JSON_CONTENT_KEY][cls.MESSAGE_KEY][message_type]
        )
    ...
    def format_output_json(cls, output_json: Dict[str, Any], output_use_case_json: Dict[str, Any]) -> Dict[str, Any]:
        message_type = cls.get_message_type()
        output_json[cls.CONTENT_KEY][0][cls.JSON_CONTENT_KEY][cls.EMBEDDED_JSON_CONTENT_KEY][cls.MESSAGE_KEY][message_type] = output_use_case_json
        return output_json
