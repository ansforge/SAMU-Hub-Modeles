...
class BaseMessageConverter:
        ...
        try:
            ...
            if abs(source_version_index - target_version_index) == 1:
                if source_version_index < target_version_index:
                    ...
                    return cls.downgrade(source_version, source_version_index, edxl_json)
    ...
    def raise_conversion_not_implemented_error(cls, source_version, target_version):
        raise ValueError(f"Version conversion from {source_version} to {target_version} for message type '{cls.get_message_type()}' is currently not implemented.")
