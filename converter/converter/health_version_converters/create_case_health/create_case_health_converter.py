...
from converter.health_version_converters.create_case_health.v1_v2.constants import (
    V1V2Constants,
)
...
from converter.health_version_converters.create_case_health.v2_v3.constants import (
    V2V3Constants,
)
