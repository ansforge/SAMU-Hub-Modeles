...
class TestValidateDiagnosisCode(unittest.TestCase):
    ...
    def test_validate_diagnosis_code_no_correct_code(self, mock_choices):
        ...
        self.assertEqual(json_data, {'otherKey': 'value', 'patient': [{'patientId': 'fr.health.samuH.ERTYUI.GHK', 'key1': 'value1', 'key2': 'value2'}], 'medicalNote': [{'patientId': 'fr.health.samuH.ERTYUI.GHK', 'medicalNoteId': 'fr.health.samuH.medicalNote.f5de', 'freetext': 'Diagnostique(s) secondaire(s) : code: MAUVAISCODE\nlabel: Faux code\n', 'operator': {'role': 'AUTRE'}}, {'patientId': 'fr.health.samuH.ERTYUI.GHK', 'medicalNoteId': 'fr.health.samuH.medicalNote.a3b2', 'freetext': 'Diagnostique(s) secondaire(s) : code: MAUVAISCODE\nlabel: Faux code\n', 'operator': {'role': 'AUTRE'}}, {'patientId': 'fr.health.samuH.ERTYUI.GHK', 'medicalNoteId': 'fr.health.samuH.medicalNote.c9d8', 'freetext': 'Diagnostique(s) secondaire(s) : code: MAUVAISCODE\nlabel: Faux code\n', 'operator': {'role': 'AUTRE'}}, {'patientId': 'fr.health.samuH.ERTYUI.GHK', 'medicalNoteId': 'fr.health.samuH.medicalNote.f5de', 'freetext': 'Diagnostique(s) secondaire(s) : code: MAUVAISCODE\nlabel: Faux code\n', 'operator': {'role': 'AUTRE'}}, {'patientId': 'fr.health.samuH.ERTYUI.GHK', 'medicalNoteId': 'fr.health.samuH.medicalNote.a3b2', 'freetext': 'Diagnostique principal : code: MAUVAISCODE\nlabel: Faux code\n', 'operator': {'role': 'AUTRE'}}]})
