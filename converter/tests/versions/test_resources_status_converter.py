...
def test_V1_to_V2_upgrade():
    v2_schema_endpoint = get_file_endpoint(TestConstants.V2_GITHUB_TAG, TestConstants.RS_SR_TAG)
...
def test_V2_to_V1_downgrade():
    v1_schema_endpoint = get_file_endpoint(TestConstants.V1_GITHUB_TAG, TestConstants.RS_SR_TAG)
...
def test_V2_to_V3_upgrade():
    v3_schema_endpoint = get_file_endpoint(TestConstants.V3_GITHUB_TAG, TestConstants.RS_SR_TAG)
