...
def test_V1_to_V2_upgrade():
    ...
    TestHelper.conversion_tests_runner(
        sample_dir=Constants.RS_DR_TAG,
...
def test_V2_to_V1_downgrade():
    v1_schema_endpoint = get_file_endpoint(Constants.V1_GITHUB_TAG, Constants.RS_DR_TAG)
...
def test_V2_to_V3_upgrade():
    v3_schema_endpoint = get_file_endpoint(Constants.V3_GITHUB_TAG, Constants.RS_DR_TAG)
