...
class TestHelper:
    ...
    def get_json_files_local(directory: str) -> list:
        ...
        usecase_files = list(map(lambda file: {'name': file.name, 'path': str(file)}, path.glob("*.json")))
    ...
    def conversion_tests_runner(sample_dir: str, 
        ...
        for usecase_file in usecase_files:
            ...
            edxl_json = TestHelper.create_edxl_json_from_sample(envelope_file, usecase_file['path']);
