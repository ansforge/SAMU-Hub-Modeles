...
class TestConversionStrategy(unittest.TestCase):
    ...
    @staticmethod
    def run_health_version_conversion_strategy(
        message_type: str,
    ) -> Tuple[str, str, Dict]:
        ...
        health_version_conversion_strategy(edxl_json, source_version, target_version)
    ...
    def test_health_version_conversion_strategy_should_convert_create_case_health_message(
        self, mock_convert
    ):
        args = self.run_health_version_conversion_strategy(TestConstants.RS_EDA_TAG)
    ...
    def test_health_version_conversion_strategy_should_convert_create_case_health_update_message(
        self, mock_convert
    ):
        args = self.run_health_version_conversion_strategy(TestConstants.RS_EDA_MAJ_TAG)
        mock_convert.assert_called_once_with(*args)

    @patch(
        "converter.health_version_converters.reference.reference_converter.ReferenceConverter.convert"
    )
    def test_health_version_conversion_strategy_should_convert_reference_message(
        self, mock_convert
    ):
        args = self.run_health_version_conversion_strategy(TestConstants.RC_REF_TAG)
        mock_convert.assert_called_once_with(*args)

    @patch("converter.health_version_converters.error_converter.ErrorConverter.convert")
    def test_health_version_conversion_strategy_should_convert_error_message(
        self, mock_convert
    ):
        args = self.run_health_version_conversion_strategy(TestConstants.RS_ERROR_TAG)
        mock_convert.assert_called_once_with(*args)

    @patch(
        "converter.health_version_converters.resources_status.resources_status_converter.ResourcesStatusConverter.convert"
    )
    def test_health_version_conversion_strategy_should_convert_resources_status_message(
        self, mock_convert
    ):
        args = self.run_health_version_conversion_strategy(TestConstants.RS_SR_TAG)
        mock_convert.assert_called_once_with(*args)

    @patch(
        "converter.health_version_converters.resources_info.resources_info_converter.ResourcesInfoConverter.convert"
    )
    def test_health_version_conversion_strategy_should_convert_resources_info_message(
        self, mock_convert
    ):
        args = self.run_health_version_conversion_strategy(TestConstants.RS_RI_TAG)
        mock_convert.assert_called_once_with(*args)
    ...
    def test_health_version_conversion_strategy_should_convert_resources_response_message(
        ...
        args = self.run_health_version_conversion_strategy(TestConstants.RS_RR_TAG)
        mock_convert.assert_called_once_with(*args)
    ...
    def test_health_version_conversion_strategy_should_convert_resources_request_message(
        ...
        args = self.run_health_version_conversion_strategy(TestConstants.RS_DR_TAG)
        mock_convert.assert_called_once_with(*args)
    ...
    def test_health_version_conversion_strategy_should_convert_resources_engagement_message(
        self, mock_convert
    ):
        args = self.run_health_version_conversion_strategy(TestConstants.RS_ER_TAG)
        mock_convert.assert_called_once_with(*args)
    ...
    def test_health_version_conversion_strategy_should_convert_geo_positions_update_message(
        self, mock_convert
    ):
        args = self.run_health_version_conversion_strategy(TestConstants.GEO_POS_TAG)
        mock_convert.assert_called_once_with(*args)

    @patch(
        "converter.health_version_converters.identical_message_converter.IdenticalMessageConverter.convert"
    )
    def test_health_version_conversion_strategy_should_convert_geo_resources_requests_message(
        self, mock_convert
    ):
        args = self.run_health_version_conversion_strategy(TestConstants.GEO_REQ_TAG)
        mock_convert.assert_called_once_with(*args)
    ...
    def test_health_version_conversion_strategy_should_convert_geo_resources_details_message(
        self, mock_convert
    ):
        args = self.run_health_version_conversion_strategy(TestConstants.GEO_RES_TAG)
        mock_convert.assert_called_once_with(*args)
