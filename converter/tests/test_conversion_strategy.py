...
class TestConversionStrategy(unittest.TestCase):
    ...
    def test_conversion_strategy_with_cisu_conversion(self, mock_cisu_conversion_strategy):
        edxl_json = {}
    ...
    def test_conversion_strategy_with_health_conversion(self, mock_health_conversion_strategy):
        ...
        mock_health_conversion_strategy.assert_called_once_with(edxl_json, source_version, target_version)
