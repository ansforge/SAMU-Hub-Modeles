...
public class PocContentWrapper {

    @JsonProperty(value = "embeddedJsonContent")
    @JacksonXmlProperty(localName = "embeddedXMLContent")
    private PocEmbeddedContent embeddedContent;

    public PocContentWrapper() {
    }

    public PocContentWrapper(PocEmbeddedContent embeddedContent) {
        this.embeddedContent = embeddedContent;
    }

    public PocEmbeddedContent getPocEmbeddedContent() {
        return embeddedContent;
    }

    public void setPocEmbeddedContent(PocEmbeddedContent embeddedContent) {
        this.embeddedContent = embeddedContent;
    }
    ...
    public boolean equals(Object o) {
        ...
        PocContentWrapper that = (PocContentWrapper) o;
