 ...
 */
@JsonPropertyOrder(
    {Location.JSON_PROPERTY_LOC_I_D, Location.JSON_PROPERTY_TYPE,
     Location.JSON_PROPERTY_LOC_LABEL, Location.JSON_PROPERTY_NAME,
...
public class Location {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(locID, type, locLabel, name, externalLocationId,
