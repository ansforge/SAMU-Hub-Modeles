...
public class Request {
  ...
  public enum ConventionEnum {
    DRSIS(String.valueOf("DRSIS")),

    MISSION(String.valueOf("MISSION")),

    ITSP(String.valueOf("ITSP")),

    CARENCE(String.valueOf("CARENCE")),

    CONVENT(String.valueOf("CONVENT")),

    SPE(String.valueOf("SPE")),

    HORS(String.valueOf("HORS")),

    AUTRE1(String.valueOf("AUTRE1")),

    AUTRE2(String.valueOf("AUTRE2")),

    AUTRE3(String.valueOf("AUTRE3"));
  ...
  public enum PurposeEnum {
    SAP(String.valueOf("SAP")),

    REGUL(String.valueOf("REGUL")),

    CUMP(String.valueOf("CUMP")),
    ...
    SAMU(String.valueOf("SAMU")),

    RELEVE(String.valueOf("RELEVE")),

    NOVI(String.valueOf("NOVI")),

    TIH(String.valueOf("TIH")),

    BRANCARD(String.valueOf("BRANCARD")),

    BARIA(String.valueOf("BARIA"));
  ...
  public enum DeadlineEnum {
    DEL0(String.valueOf("DEL0")),

    ASAP(String.valueOf("ASAP")),

    _30_M(String.valueOf("30M")),

    _45_M(String.valueOf("45M")),

    _1_H(String.valueOf("1H")),

    _2_H(String.valueOf("2H")),

    _4_H(String.valueOf("4H")),

    _8_H(String.valueOf("8H")),

    _12_H(String.valueOf("12H")),

    _24_H(String.valueOf("24H")),

    RDV(String.valueOf("RDV"));
