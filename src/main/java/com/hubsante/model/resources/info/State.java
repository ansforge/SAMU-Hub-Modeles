...
public class State {
  ...
  public enum StatusEnum {
    DECISION(String.valueOf("DECISION")),

    DECLENCHE(String.valueOf("DECLENCHE")),

    DEPART(String.valueOf("DEPART")),

    ANNULE(String.valueOf("ANNULE")),

    ARRIVEE(String.valueOf("ARRIVEE")),

    PEC(String.valueOf("PEC")),

    BILAN(String.valueOf("BILAN")),

    ORIENTAT(String.valueOf("ORIENTAT")),

    TRANSP(String.valueOf("TRANSP")),

    ETAPE1(String.valueOf("ETAPE1")),

    TRANSP2(String.valueOf("TRANSP2")),

    ETAPE2(String.valueOf("ETAPE2")),

    TRANSP3(String.valueOf("TRANSP3")),

    DESTIN(String.valueOf("DESTIN")),

    FINPEC(String.valueOf("FINPEC")),

    RETOUR(String.valueOf("RETOUR")),

    RET_BASE(String.valueOf("RET-BASE")),

    REN_BASE(String.valueOf("REN-BASE"));
