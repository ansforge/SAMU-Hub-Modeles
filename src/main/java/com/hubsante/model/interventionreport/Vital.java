...
public class Vital {
  ...
  public enum TypeEnum {
    FREQUENCE_CARDIAQUE(String.valueOf("FREQUENCE_CARDIAQUE")),

    PRESSION_ARTERIELLE(String.valueOf("PRESSION_ARTERIELLE")),

    SATURATION_OXYGENE(String.valueOf("SATURATION_OXYGENE")),

    FREQUENCE_RESPIRATOIRE(String.valueOf("FREQUENCE_RESPIRATOIRE")),

    TEMPERATURE(String.valueOf("TEMPERATURE")),

    HEMOGLOCOTEST(String.valueOf("HEMOGLOCOTEST")),

    GLASGOW(String.valueOf("GLASGOW"));
