...
public class Qualification {
  ...
  public enum OriginEnum {
    ...
    _116117(String.valueOf("116117")),

    AUTOCOM(String.valueOf("AUTOCOM")),

    _112(String.valueOf("112")),

    _115(String.valueOf("115")),

    CRRA(String.valueOf("CRRA")),

    AUTREC15(String.valueOf("AUTREC15")),

    CTA_CONF(String.valueOf("CTA-CONF")),

    CTA_PI(String.valueOf("CTA-PI")),

    AUTRECTA(String.valueOf("AUTRECTA")),

    CNR(String.valueOf("CNR")),

    FDO(String.valueOf("FDO")),

    SNATED(String.valueOf("SNATED")),

    PDSSOS(String.valueOf("PDSSOS")),

    TELASSIST(String.valueOf("TELASSIST")),
