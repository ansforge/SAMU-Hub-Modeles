...
public class Mission {
  ...
  public enum TYPEEnum {
    SAV_ASC(String.valueOf("SAV/ASC")),

    FR_MED_REGLTN(String.valueOf("FR_MED/REGLTN")),

    GEN_SUPRTN(String.valueOf("GEN/SUPRTN")),

    SAV_AR_FR_MED(String.valueOf("SAV/AR/FR_MED")),

    SAV_AR_FR_PARAMD(String.valueOf("SAV/AR/FR_PARAMD")),

    SAV(String.valueOf("SAV")),

    GEN_TRNSPN(String.valueOf("GEN/TRNSPN")),

    SAV_SARCSL(String.valueOf("SAV/SARCSL")),

    SAV_ASC_FR_PPL_LIFT(String.valueOf("SAV/ASC/FR_PPL/LIFT")),

    GEN_RECVRY(String.valueOf("GEN/RECVRY")),

    SAV_RHD(String.valueOf("SAV/RHD")),

    FFST_FR_FIRE(String.valueOf("FFST/FR_FIRE")),

    FSTT_RRHAZ_FR_CO(String.valueOf("FSTT/RRHAZ/FR_CO")),

    CBRN_TSA(String.valueOf("CBRN/TSA")),

    INT_RECCE_FR_SMLL(String.valueOf("INT/RECCE/FR_SMLL")),

    FSTT_TA(String.valueOf("FSTT/TA")),

    SAV_AR_FR_PPL_GRP(String.valueOf("SAV/AR/FR_PPL/GRP")),

    INT_RECCE(String.valueOf("INT/RECCE")),

    GEN_TRNSPN_FR_SECNDRY(String.valueOf("GEN/TRNSPN/FR_SECNDRY")),

    OPR_LOG(String.valueOf("OPR/LOG")),

    SAV_AR_FR_PPL_OBS(String.valueOf("SAV/AR/FR_PPL/OBS")),

    FSTT_TA_FR_CLRACCSS(String.valueOf("FSTT/TA/FR_CLRACCSS"));
  ...
  public enum STATUSEnum {
    ABO(String.valueOf("ABO")),

    NST(String.valueOf("NST")),

    CANCLD(String.valueOf("CANCLD")),

    COM(String.valueOf("COM")),

    IPR(String.valueOf("IPR")),

    PAU(String.valueOf("PAU"));
