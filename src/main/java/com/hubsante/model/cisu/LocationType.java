...
public class LocationType {
    ...
    public LocationType(
            String locId, String name, Type type, String coordsys, HeightRole heightRole, List<CoordType> coord, List<String> address, String commune, CivicAddressType civicAddress
    ) {
        this.locId = locId;
        this.name = name;
        this.type = type;
    ...
    public HeightRole getHeightRole() {
        return this.heightRole;
    }

    public void setHeightRole(HeightRole heightRole) {
        this.heightRole = heightRole;
    }
    ...
    public void setCoord(List<CoordType> coord) {
        if (this.coord == null) {
            this.coord = new ArrayList<>(coord.size());
        }
    ...
    public void setAddress(List<String> address) {
        if (this.address == null) {
            this.address = new ArrayList<>(address.size());
        }
    ...
    public CivicAddressType getCivicAddress() {
        return this.civicAddress;
    }

    public void setCivicAddress(CivicAddressType civicAddress) {
        this.civicAddress = civicAddress;
    }
