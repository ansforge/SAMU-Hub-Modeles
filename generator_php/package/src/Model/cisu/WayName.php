 ...
 */
class WayName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'wayName';
    ...
    */
     ...
     * Sets complete
     *
     * @param string $complete A valoriser avec le type et le nom de la voie. Si les attributs \"type\" et \"name\" de \"wayName\" sont également renseignés, alors \"complete\" doit être valorisé ainsi : \"{type} {nom}\".
     *
     * @return self
     */
