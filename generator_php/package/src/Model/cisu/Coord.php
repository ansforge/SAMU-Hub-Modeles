...
class Coord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const PRECISION_VILLE = 'VILLE';
    public const PRECISION_RUE = 'RUE';
    public const PRECISION_ADRESSE = 'ADRESSE';
    public const PRECISION_EXACTE = 'EXACTE';
    public const PRECISION_INCONNUE = 'INCONNUE';
    ...
    {
        return [
            self::PRECISION_VILLE,
            self::PRECISION_RUE,
            self::PRECISION_ADRESSE,
            self::PRECISION_EXACTE,
    ...
    */
     ...
     * Sets lat
     *
     * @param float $lat A valoriser avec la latitude du point clé de la localisation - dans le système de coordonnées EPSG-4326 (indiquant l'utilisation de WGS-84)
     *
     * @return self
     */
     ...
     * Sets lon
     *
     * @param float $lon A valoriser avec la longitude du point clé de la localisation - dans le système de coordonnées EPSG-4326 (indiquant l'utilisation de WGS-84)
     *
     * @return self
     */
     ...
     * Sets speed
     *
     * @param float|null $speed Vitesse en km/h, notamment fournie par eCall, tel, nouveau AML, …
     *
     * @return self
     */
    ...
    public function setPrecision($precision)
    {
        ...
        $allowedValues = $this->getPrecisionAllowableValues();
        if (!in_array($precision, $allowedValues, true)) {
