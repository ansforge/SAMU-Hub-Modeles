...
class Sender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets uRI
     *
     * @param string $uRI uri du système. Permet d'identifier le vecteur utilisé par les échanges Format : => Pour les LRM : {nom éditeur}:{sender:name} => Pour NexSIS : sge:{sender:name}
     *
     * @return self
     */
