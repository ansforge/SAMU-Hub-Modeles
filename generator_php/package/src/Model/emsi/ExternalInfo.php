...
class ExternalInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const T_YPE_MANUAL = 'MANUAL';
    public const T_YPE_MAP = 'MAP';
    public const T_YPE_OTHER = 'OTHER';
    public const T_YPE_PHOTO = 'PHOTO';
    public const T_YPE_WEBSIT = 'WEBSIT';
