...
/**
 * ResourcesRequest Class Doc Comment
 *
 * @category Class
 * @package  Hubsante
 * @author   OpenAPI Generator team
 ...
 */
class ResourcesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'resourcesRequest';
    ...
    protected static $openAPITypes = [
        'caseId' => 'string',
        'request' => '\Hubsante\Model\resources.request\Request',
        'status' => 'string'
    ];
    ...
    */
    ...
    public function setCaseId($caseId)
    {
        ...
        if ((!preg_match("/^([a-zA-Z0-9_-]+\\.?){4,10}$/", ObjectSerializer::toString($caseId)))) {
            throw new \InvalidArgumentException("invalid value for \$caseId when calling ResourcesRequest., must conform to the pattern /^([a-zA-Z0-9_-]+\\.?){4,10}$/.");
        }
     ...
     * Gets request
     *
     * @return \Hubsante\Model\resources.request\Request
     */
     ...
     * Sets request
     *
     * @param \Hubsante\Model\resources.request\Request $request request
     *
     * @return self
     */
