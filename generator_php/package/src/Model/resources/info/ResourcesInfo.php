...
/**
 * ResourcesInfo Class Doc Comment
 *
 * @category Class
 * @package  Hubsante
 * @author   OpenAPI Generator team
 ...
 */
class ResourcesInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'resourcesInfo';
    ...
    protected static $openAPITypes = [
        'caseId' => 'string',
        'resource' => '\Hubsante\Model\resources.info\Resource[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['resource']) < 1)) {
            $invalidProperties[] = "invalid value for 'resource', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets resource
     *
     * @return \Hubsante\Model\resources.info\Resource[]
     */
     ...
     * Sets resource
     *
     * @param \Hubsante\Model\resources.info\Resource[] $resource resource
     *
     * @return self
     */
    public function setResource($resource)
    {
        ...
        if ((count($resource) < 1)) {
            throw new \InvalidArgumentException('invalid length for $resource when calling ResourcesInfo., number of items must be greater than or equal to 1.');
        }
