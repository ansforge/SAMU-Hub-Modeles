...
namespace HubsanteModel.Health.Model
{
    ...
    public partial class RiskThreat : IEquatable<RiskThreat>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RiskThreat);
        }

        /// <summary>
        /// Returns true if RiskThreat instances are equal
        /// </summary>
        /// <param name="input">Instance of RiskThreat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RiskThreat input)
        {
            if (input == null)
            {
                return false;
