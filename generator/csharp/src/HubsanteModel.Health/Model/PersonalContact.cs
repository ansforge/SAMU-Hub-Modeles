...
namespace HubsanteModel.Health.Model
{
    ...
    public partial class PersonalContact : IEquatable<PersonalContact>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PersonalContact);
        }

        /// <summary>
        /// Returns true if PersonalContact instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonalContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonalContact input)
        {
            if (input == null)
            {
                return false;
