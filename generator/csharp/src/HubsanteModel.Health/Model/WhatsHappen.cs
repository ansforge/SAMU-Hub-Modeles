...
namespace HubsanteModel.Health.Model
{
    ...
    public partial class WhatsHappen : IEquatable<WhatsHappen>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>A valoriser avec le code de la nomenclature associée</value>
        /// <example>example.json#/qualification/whatsHappen/code</example>
        ...
        /// <example>example.json#/qualification/whatsHappen/label</example>
        ...
        {
            return this.Equals(input as WhatsHappen);
        }

        /// <summary>
        /// Returns true if WhatsHappen instances are equal
        /// </summary>
        /// <param name="input">Instance of WhatsHappen to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WhatsHappen input)
        {
            if (input == null)
            {
                return false;
