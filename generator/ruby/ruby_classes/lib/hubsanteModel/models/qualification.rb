...
module Health
  class Qualification
    ...
    def valid?
      ...
      origin_validator = EnumAttributeValidator.new('String', ["15", "116117", "AUTOCOM", "112", "115", "CRRA", "AUTREC15", "CTA-CONF", "CTA-PI", "AUTRECTA", "CNR", "FDO", "SNATED", "PDSSOS", "TELASSIST", "CROSS", "PUBLIC", "DATA", "AUTRE"])
    ...
    def origin=(origin)
      validator = EnumAttributeValidator.new('String', ["15", "116117", "AUTOCOM", "112", "115", "CRRA", "AUTREC15", "CTA-CONF", "CTA-PI", "AUTRECTA", "CNR", "FDO", "SNATED", "PDSSOS", "TELASSIST", "CROSS", "PUBLIC", "DATA", "AUTRE"])
