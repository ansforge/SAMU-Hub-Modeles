...
class ExternalId(BaseModel):
    ...
    ExternalId
    """ # noqa: E501
    source: StrictStr = Field(description="Type de l'identifiant fourni")
    value: StrictStr = Field(description="L'identifiant en lui-même")
    __properties: ClassVar[List[str]] = ["source", "value"]

    @field_validator('source')
    def source_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('NIR', 'SINUS', 'SI-VIC', 'DOSSARD', 'PLACE'):
