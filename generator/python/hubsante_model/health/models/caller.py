...
class Caller(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('SUJET', 'FAMILLE', 'TIERS', 'POMPIER', 'AMBULANC', 'AMBULANC.AASC', 'AMBULANC.AUTRESEC', 'SECOUR', 'MED', 'MED.MEDSOS', 'MED.MRL', 'MED.EFFML', 'SANTE', 'SANTE.INF', 'SANTE.AIDESOIN', 'SANTE.SF', 'SANTE.AIDEDOM', 'SANTE.PHARMA', 'SANTE.DENTISTE', 'SANTE.LABO', 'FDO-MILI', 'FDO-MILI.POL', 'FDO-MILI.GENDARM', 'FDO-MILI.MILI', 'ADM-TUTL', 'VIP', 'OBJCONNC', 'AUTRE', 'INCONNU'):
