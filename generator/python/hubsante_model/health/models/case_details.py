...
class CaseDetails(BaseModel):
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('PROGRAM', 'ACTIF', 'ACHEVE', 'VALIDE', 'CLOTURE', 'CLASSE', 'ARCHIVE'):
