...
class CaseDetails(BaseModel):
    ...
    def attribution_validate_enum(cls, value):
        ...
        if value not in ('DRM', 'DRM.MRU', 'DRM.MRU.MU', 'DRM.MRU.INDISPMU', 'DRM.MRU.SSE', 'DRM.MRU.PLANBLAN', 'DRM.MRU.PCSAMU', 'DRM.SPE', 'DRM.SPE.DENT', 'DRM.SPE.GERIA', 'DRM.SPE.PEDIA', 'DRM.SPE.OBST', 'DRM.SPE.PSY', 'DRM.SPE.TOXICOL', 'DRM.MRL', 'DRM.MRL.MG', 'DRM.MRL.INDISPMG', 'DRM.MRL.ABSML', 'DR', 'DR.DREG', 'DR.DREG.DRARM', 'DR.DREG.DRDAC', 'DR.DREG.DRMED', 'DR.DREG.DRPHARMA', 'DR.DREG.DRDENT', 'DR.DREG.DRINFO', 'DR.DREG.DOS-SIS', 'DR.DREG.DOS-FDO', 'D', 'D.D-MALV', 'D.D-MALV.ERR', 'D.D-MALV.NRP', 'D.D-MALV.MALV', 'D.D-MALV.FAX', 'D.D-MALV.ITERATIF', 'D.D-IDENT', 'D.D-IDENT.ADMIN', 'D.D-IDENT.PERSO', 'D.D-IDENT.AUTRE'):
            raise ValueError("must be one of enum values ('DRM', 'DRM.MRU', 'DRM.MRU.MU', 'DRM.MRU.INDISPMU', 'DRM.MRU.SSE', 'DRM.MRU.PLANBLAN', 'DRM.MRU.PCSAMU', 'DRM.SPE', 'DRM.SPE.DENT', 'DRM.SPE.GERIA', 'DRM.SPE.PEDIA', 'DRM.SPE.OBST', 'DRM.SPE.PSY', 'DRM.SPE.TOXICOL', 'DRM.MRL', 'DRM.MRL.MG', 'DRM.MRL.INDISPMG', 'DRM.MRL.ABSML', 'DR', 'DR.DREG', 'DR.DREG.DRARM', 'DR.DREG.DRDAC', 'DR.DREG.DRMED', 'DR.DREG.DRPHARMA', 'DR.DREG.DRDENT', 'DR.DREG.DRINFO', 'DR.DREG.DOS-SIS', 'DR.DREG.DOS-FDO', 'D', 'D.D-MALV', 'D.D-MALV.ERR', 'D.D-MALV.NRP', 'D.D-MALV.MALV', 'D.D-MALV.FAX', 'D.D-MALV.ITERATIF', 'D.D-IDENT', 'D.D-IDENT.ADMIN', 'D.D-IDENT.PERSO', 'D.D-IDENT.AUTRE')")
        return value
