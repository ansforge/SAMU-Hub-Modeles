...
from openapi_client.models.highway import Highway
from openapi_client.models.way_name import WayName
try:
...
class DetailedAddress(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["highway", "complete", "number", "wayName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of highway
        if self.highway:
            _dict['highway'] = self.highway.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "highway": Highway.from_dict(obj.get("highway")) if obj.get("highway") is not None else None,
            "complete": obj.get("complete"),
            "number": obj.get("number"),
            "wayName": WayName.from_dict(obj.get("wayName")) if obj.get("wayName") is not None else None
        })
        return _obj
