...
from openapi_client.models.case_details import CaseDetails
from openapi_client.models.health_motive import HealthMotive
from openapi_client.models.location_kind import LocationKind
from openapi_client.models.risk_threat import RiskThreat
from openapi_client.models.whats_happen import WhatsHappen
try:
...
class Qualification(BaseModel):
    ...
    def origin_validate_enum(cls, value):
        ...
        if value not in ('15', '18', '17', '112', '116117'):
            raise ValueError("must be one of enum values ('15', '18', '17', '112', '116117')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "riskThreat": [RiskThreat.from_dict(_item) for _item in obj.get("riskThreat")] if obj.get("riskThreat") is not None else None,
            "whatsHappen": WhatsHappen.from_dict(obj.get("whatsHappen")) if obj.get("whatsHappen") is not None else None,
            "locationKind": LocationKind.from_dict(obj.get("locationKind")) if obj.get("locationKind") is not None else None,
            "healthMotive": HealthMotive.from_dict(obj.get("healthMotive")) if obj.get("healthMotive") is not None else None,
            "details": CaseDetails.from_dict(obj.get("details")) if obj.get("details") is not None else None
        })
        return _obj
