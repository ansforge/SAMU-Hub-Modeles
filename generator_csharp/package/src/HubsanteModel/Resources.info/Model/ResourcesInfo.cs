...
namespace HubsanteModel/Resources.info.Model
{
    ...
    /// ResourcesInfo
    /// </summary>
    [DataContract(Name = "resourcesInfo")]
    public partial class ResourcesInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourcesInfo" /> class.
        /// </summary>
        ...
        public ResourcesInfo(string caseId = default(string), List<Resource> resource = default(List<Resource>))
        {
            // to ensure "caseId" is required (not null)
            if (caseId == null)
            {
                throw new ArgumentNullException("caseId is a required property for ResourcesInfo and cannot be null");
            }
            this.CaseId = caseId;
            // to ensure "resource" is required (not null)
            if (resource == null)
            {
                throw new ArgumentNullException("resource is a required property for ResourcesInfo and cannot be null");
            }
