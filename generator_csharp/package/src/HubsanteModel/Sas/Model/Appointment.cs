...
namespace HubsanteModel/Sas.Model
{
    ...
    public partial class Appointment : IValidatableObject
    {
        ...
        */
        ...
        public Appointment(string appointmentId = default(string), MethodEnum method = default(MethodEnum), DateTime created = default(DateTime), DateTime start = default(DateTime), DateTime end = default(DateTime), StatusEnum status = default(StatusEnum), OrientationCategoryEnum? orientationCategory = default(OrientationCategoryEnum?), Practitioner practitioner = default(Practitioner), Organization organization = default(Organization))
        {
