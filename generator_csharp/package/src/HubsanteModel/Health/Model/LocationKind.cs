...
namespace HubsanteModel/Health.Model
{
    ...
    public partial class LocationKind : IValidatableObject
    {
        ...
        public LocationKind(string code = default(string), string label = default(string))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for LocationKind and cannot be null");
            }
            this.Code = code;
        ...
        */
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            if (this.Code != null) {
                // Code (string) pattern
                Regex regexCode = new Regex(@"^L\d{2}(\.\d{2}){2}$", RegexOptions.CultureInvariant);
