...
namespace HubsanteModel/Cisu.Model
{
    ...
    public partial class ExternalInfo : IValidatableObject
    {
        ...
        */
        ...
        /// <param name="type">A valoriser avec la définition du type d&#39;objet dans le système  Exemple : SIG NexSIS / OSM ont plusieurs types de données (EGA, POI, tronçon de route, …) (required).</param>
