...
namespace HubsanteModel/Cisu.Model
{
    ...
    public partial class Location : IValidatableObject
    {
        ...
        /// </summary>
        /*
        <example>example.json#/location/country</example>
        */
        ...
        public Location(string locID = default(string), string locLabel = default(string), string name = default(string), List<ExternalLocationId> externalLocationId = default(List<ExternalLocationId>), DetailedAddress detailedAddress = default(DetailedAddress), City city = default(City), Access access = default(Access), Geometry geometry = default(Geometry), List<ExternalInfo> externalInfo = default(List<ExternalInfo>), CountryEnum country = default(CountryEnum), string freetext = default(string))
        {
            // to ensure "locID" is required (not null)
            if (locID == null)
            {
                throw new ArgumentNullException("locID is a required property for Location and cannot be null");
            }
            this.LocID = locID;
        ...
        /// </summary>
        /// <value>ID technique et provisoire permettant d&#39;identifier le lieu dans le cadre des échanges de cette affaire.</value>
        /*
        <example>example.json#/location/locID</example>
        */
        [DataMember(Name = "locID", IsRequired = true, EmitDefaultValue = true)]
        public string LocID { get; set; }

        /// <summary>
        /// Donne les informations minimales d&#39;identification du lieu d&#39;intervention, qui permet d&#39;identifier rapidement le lieu pour les équipes opérationnelles. Comprend au maximum 255 caractères. 15-18 : Dans les messages NexSIS, va souvent correspondre à la concaténation suivant des règles métiers de différentes informations, dont le \&quot;name\&quot; (toponyme) et l&#39;adresse. 
        /// </summary>
        /// <value>Donne les informations minimales d&#39;identification du lieu d&#39;intervention, qui permet d&#39;identifier rapidement le lieu pour les équipes opérationnelles. Comprend au maximum 255 caractères. 15-18 : Dans les messages NexSIS, va souvent correspondre à la concaténation suivant des règles métiers de différentes informations, dont le \&quot;name\&quot; (toponyme) et l&#39;adresse. </value>
        /*
        <example>example.json#/location/locLabel</example>
        */
        [DataMember(Name = "locLabel", EmitDefaultValue = false)]
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LocLabel: ").Append(LocLabel).Append("\n");
