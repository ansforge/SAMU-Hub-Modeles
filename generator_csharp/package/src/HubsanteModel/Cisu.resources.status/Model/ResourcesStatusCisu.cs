...
namespace HubsanteModel/Cisu.resources.status.Model
{
    ...
    /// ResourcesStatusCisu
    /// </summary>
    [DataContract(Name = "resourcesStatusCisu")]
    public partial class ResourcesStatusCisu : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourcesStatusCisu" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourcesStatusCisu() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourcesStatusCisu" /> class.
        /// </summary>
        ...
        public ResourcesStatusCisu(string caseId = default(string), string resourceId = default(string), State state = default(State))
        {
            // to ensure "caseId" is required (not null)
            if (caseId == null)
            {
                throw new ArgumentNullException("caseId is a required property for ResourcesStatusCisu and cannot be null");
            }
            this.CaseId = caseId;
            // to ensure "resourceId" is required (not null)
            if (resourceId == null)
            {
                throw new ArgumentNullException("resourceId is a required property for ResourcesStatusCisu and cannot be null");
            }
            this.ResourceId = resourceId;
            // to ensure "state" is required (not null)
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for ResourcesStatusCisu and cannot be null");
            }
            this.State = state;
        }
