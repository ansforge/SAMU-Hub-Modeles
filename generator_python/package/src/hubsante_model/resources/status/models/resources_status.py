...
from hubsante_model.resources.status.models.state import State
...
class ResourcesStatus(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResourcesStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResourcesStatus from a dict"""
        if obj is None:
            return None
