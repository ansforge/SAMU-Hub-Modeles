...
class DetailedAddress(BaseModel):
    ...
    DetailedAddress
    """ # noqa: E501
    insee_code: Annotated[str, Field(strict=True)] = Field(description="Code INSEE de la commune actuelle sur la base du Code Officiel géographique en vigueur. Obligatoire si le nom de la commune est renseigné. Le Code INSEE peut également précisé le pays d'intervention, si étranger. ", alias="inseeCode")
