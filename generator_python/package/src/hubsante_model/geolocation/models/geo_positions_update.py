...
from hubsante_model.geolocation.models.position import Position
from typing import Optional, Set
from typing_extensions import Self

class GeoPositionsUpdate(BaseModel):
    """
    GeoPositionsUpdate
    """ # noqa: E501
    position: Annotated[List[Position], Field(min_length=1)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GeoPositionsUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GeoPositionsUpdate from a dict"""
        if obj is None:
            return None
