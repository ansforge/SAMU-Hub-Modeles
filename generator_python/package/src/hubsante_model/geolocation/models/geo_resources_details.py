...
from hubsante_model.geolocation.models.resource import Resource
from typing import Optional, Set
from typing_extensions import Self

class GeoResourcesDetails(BaseModel):
    """
    GeoResourcesDetails
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GeoResourcesDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GeoResourcesDetails from a dict"""
        if obj is None:
            return None
