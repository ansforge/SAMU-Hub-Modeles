...
from hubsante_model.technical.models.level_one_data import LevelOneData
from hubsante_model.technical.models.technical_object import TechnicalObject
...
class Technical(BaseModel):
    ...
    Technical
    """ # noqa: E501
    required_string_field: StrictStr = Field(description="This field is required", alias="requiredStringField")
    ...
    required_array: Annotated[List[StrictStr], Field(min_length=1)] = Field(alias="requiredArray")
    ...
    __properties: ClassVar[List[str]] = ["requiredStringField", "optionalStringField", "enumerationField", "integerField", "numberField", "booleanField", "objectField", "arrayField", "enumArrayField", "requiredArray", "arrayWithMaxLength", "phoneNumberField", "dateField", "emailField", "datetimeField", "objectLevel1", "nomenclatureField"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Technical from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Technical from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "requiredStringField": obj.get("requiredStringField"),
            ...
            "requiredArray": obj.get("requiredArray"),
