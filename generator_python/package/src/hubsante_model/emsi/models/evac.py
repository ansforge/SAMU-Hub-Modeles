...
class Evac(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Evac from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Evac from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "DISPLACED": obj.get("DISPLACED"),
            "EVACUATED": obj.get("EVACUATED")
        })
        return _obj
